    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <!-- <div
                ...
                <h5 class="my-0 mr-md-auto font-weight-normal">Suscribete Ahora</h5>
                <nav class="my-2 my-md-0 mr-md-3">
                    <a class="p-2 text-dark" href="#">Pantalla Principal</a>
                    <a class="p-2 text-dark" href="#">Registrate</a>
            ...
            <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
                <h1 class="display-4">Empezar Ahora <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40"
                        fill="currentColor" class="bi bi-arrow-right" viewBox="0 0 16 16">
                        <path fill-rule="evenodd"
                            d="M1 8a.5.5 0 0 1 .5-.5h11.793l-3.147-3.146a.5.5 0 0 1 .708-.708l4 4a.5.5 0 0 1 0 .708l-4 4a.5.5 0 0 1-.708-.708L13.293 8.5H1.5A.5.5 0 0 1 1 8" />
                    </svg></h1>
                <p class="lead">Elije un plan para empezar o puedes utilizar el plan gratis con Limitaciones de uso.</p>
            </div>
