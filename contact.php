...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
                        ...
                        <form>
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="inputMessage" rows="4" placeholder="Introduce tu mensaje"></textarea>
                                </div>
                            </div>
                            <!-- /.card-body -->
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2024 <a href="https://adminlte.io">Plaza UTSV</a>.</strong>
